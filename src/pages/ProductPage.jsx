    ...
    <div className={styles.container}>
      ...
      >
        ...
        <Tab eventKey="longer-tab" title="FAQ">
          <div className={styles.faq}>자주 묻는 질문</div>
          <Accordion defaultActiveKey="0" flush>
            ...
            <Accordion.Item eventKey="1">
              ...
              <Accordion.Body>
                ...
                나와있는 흔적이 있거나, 처음 분사 시 향수가 줄줄 새어나와 <br />{" "}
                불량인 것처럼 의심되는 경우가 있습니다. 이는 제조 과정 중에
                보틀과 스프레이를 결합하는 과정에서 내용물이 흘러 넘치면서
                스프레이 내부 쪽에 고여있다가 배송중에 흔들림으로 인해 결합
                부분에서 조금씩 새어나오기도 하며, <br /> 또는, 처음 분사 시
                노즐 내부의 공기때문에 스프레이 압력이 제대로 들어가지 않아
                분사가 제대로 되지 않으며 분사구를 타고 흘러 안쪽에 고이면서
                새어나온다고 느껴지기도 합니다. <br /> 1. 먼저, 스프레이 캡을
                열어 내부와 바깥쪽을 꼼꼼하게 닦아낸 후, 힘있게 눌러 2-3회 정도
                분사하여 새어나오는 것이 있는지 확인 바랍니다. * 향수마다
                스프레이 압력이 다르기 때문에 약하게 누를 경우 두번째 경우와
                동일하게 새어나오는 것 처럼 느껴질 수 있습니다. <br /> 2. 1번을
                시도하신 후 새어나오는게 없었다면, 향수를 거꾸로 뒤집어 놓으시고
                일정시간이 지난 후 새어나오는 것이 있는지 확인 바랍니다.
                <br />
                안내드린 방법에도 불구하고 계속해서 새어나온다면 고객센터로 문의
                바랍니다.
              </Accordion.Body>
            </Accordion.Item>{" "}
            ...
            <Accordion.Item eventKey="4">
              <Accordion.Header>
                {" "}
                [ 배송/반품/교환 ] 운송장번호를 받았는데 배송 조회가 되지 않아요
              </Accordion.Header>
              <Accordion.Body>
            ...
            <Accordion.Item eventKey="6">
              ...
              <Accordion.Body>
                1) 매일 오후 2시 이전까지 결제(입금)가 완료된 주문에 한하여 당일
                출고가 진행됩니다. <br />
                2) 금요일 오후 2시 이후부터 다음주 월요일 오후 2시까지의 결제가
                완료된 주문은 월요일날 출고됩니다.
            ...
            <Accordion.Item eventKey="7">
              ...
              <Accordion.Body>
                ...
                구입시에는 배송비 2,500원이 발생합니다. <br />[ 반품,교환,환불시
                ] 오배송이나 상품에 문제가 있을 경우 전자 상거래 법에 의거하여
                수령하신 날로부터 20일내인 경우에 한하여 <br /> 100% 환불이나
                교환처리 해 드리며, 소요되는 모든 비용은 저희 퍼퓸테라피가
                부담합니다. <br />
